...
public class FilmControllerMockTests {
    ...
    public void updateFilm_shouldReturn200() throws Exception {
        String film1 = "{\"name\":\"Name\",\"description\":\"Description\",\"releaseDate\":\"2000-10-20\"," +
                "\"duration\":120}";
        String film2 = "{\"id\":1,\"name\":\"Name2\",\"description\":\"Description2\",\"releaseDate\":\"2000-11-21\"," +
                "\"duration\":130}";
    ...
    public void updateFilmWithEmptyName_shouldReturn400() throws Exception {
        String film1 = "{\"name\":\"Name\",\"description\":\"Description\",\"releaseDate\":\"2000-10-20\"," +
                "\"duration\":120}";
        String film2 = "{\"id\":1,\"name\":\"\",\"description\":\"Description2\",\"releaseDate\":" +
    ...
    public void updateFilmWithoutName_shouldReturn400() throws Exception {
        String film1 = "{\"name\":\"Name\",\"description\":\"Description\",\"releaseDate\":\"2000-10-20\"," +
                "\"duration\":120}";
        String film2 = "{\"id\":1,\"description\":\"Description2\",\"releaseDate\":\"2000-11-21\",\"duration\":130}";
    ...
    public void updateFilmWithTooLongDescription_shouldReturn400() throws Exception {
        String film1 = "{\"name\":\"Name\",\"description\":\"Description\",\"releaseDate\":\"2000-10-20\"," +
                "\"duration\":120}";
        String film2 = "{\"id\":1,\"name\":\"Name2\",\"description\":\"Тестовое описание фильма, проверка передачи " +
